...
## Improvement plans
* Creating an icon for the game My initial idea is a mitre with a star on it, based on the appearance of the [Diocese of Texas website](http://www.epicenter.org)
* Possibly adding a "donate" button

## Known things to fix
* When the window is sized down, the tiles also need to re-size to still be completely visible
* 
...
## How to make changes (most of this stuff, I don't really understand)
